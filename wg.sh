...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard Installed."
	exit 1
fi

echo -e "${Info} Wireguard VPS AutoScript by RoynLim"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/Roynlim/techs28/main/ADD/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/Roynlim/techs28/main/DELETE/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/Roynlim/techs28/main/CEK/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/Roynlim/techs28/main/RENEW/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
